  ...
  return (
    <div>
      ...
      <CustomIndex
        sections={{
          es: [
            { id: '#nwp-aulas-105-content-section-whith-an-image', label: 'Ten en cuenta' },
            { id: '#nwp-aulas-105-gallery-section', label: 'Historia' },
            { id: '#nwp-aulas-105-campus-facilities', label: 'Facilidades del campus' },
            { id: '#reservasss', label: 'Reservas' },
            { id: '#nwp-aulas-105-aditional-services', label: 'Servicios adicionales' }, // Añadido 'Servicios adicionales' en español
            { id: '#nwp-aulas-105-visit-us', label: 'Visítanos' },
          ],
          en: [
            { id: '#nwp-aulas-105-content-section-whith-an-image', label: 'Take into account' },
            { id: '#nwp-aulas-105-gallery-section', label: 'History' },
            { id: '#nwp-aulas-105-campus-facilities', label: 'Campus Facilities' },
            { id: '#reservasss', label: 'Reservations' },
            { id: '#nwp-aulas-105-aditional-services', label: 'Additional services' }, // Añadido 'Additional services' en inglés
            { id: '#nwp-aulas-105-visit-us', label: 'Visit us' },
          ],
        }}
      />
    </div>
...
const container = document.getElementById('nwp-aulas-105-hero');
if (container) {
