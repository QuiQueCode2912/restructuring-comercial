  ...
  return (
    <div>
      ...
      <CustomIndex
        sections={{
          es: [
            { id: '#nwp-l-173-content-section-whith-an-image', label: 'Ten en cuenta' },
            { id: '#nwp-l-173-gallery-section', label: 'Historia' },
            { id: '#nwp-l-173-campus-facilities', label: 'Facilidades del campus' },
            { id: '#reservasss', label: 'Reservas' },
            { id: '#nwp-l-173-aditional-services', label: 'Servicios adicionales' }, // Añadido 'Servicios adicionales' en español
            { id: '#nwp-l-173-visit-us', label: 'Visítanos' },
          ],
          en: [
            { id: '#nwp-l-173-content-section-whith-an-image', label: 'Take into account' },
            { id: '#nwp-l-173-gallery-section', label: 'History' },
            { id: '#nwp-l-173-campus-facilities', label: 'Campus Facilities' },
            { id: '#reservasss', label: 'Reservations' },
            { id: '#nwp-l-173-aditional-services', label: 'Additional services' }, // Añadido 'Additional services' en inglés
            { id: '#nwp-l-173-visit-us', label: 'Visit us' },
          ],
        }}
      />
    </div>
...
const container = document.getElementById('nwp-l-173-hero');
if (container) {
