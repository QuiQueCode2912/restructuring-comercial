  ...
  return (
    <div>
      ...
      <CustomIndex
        sections={{
          es: [
            { id: '#nwp-centro-convenciones-content-section-whith-an-image', label: 'Ten en cuenta' },
            { id: '#nwp-centro-convenciones-gallery-section', label: 'Historia' },
            { id: '#nwp-centro-convenciones-campus-facilities', label: 'Facilidades del campus' },
            { id: '#reservasss', label: 'Reservas' },
            { id: '#nwp-centro-convenciones-aditional-services', label: 'Servicios adicionales' }, // Añadido 'Servicios adicionales' en español
            { id: '#nwp-centro-convenciones-visit-us', label: 'Visítanos' },
          ],
          en: [
            { id: '#nwp-centro-convenciones-content-section-whith-an-image', label: 'Take into account' },
            { id: '#nwp-centro-convenciones-gallery-section', label: 'History' },
            { id: '#nwp-centro-convenciones-campus-facilities', label: 'Campus Facilities' },
            { id: '#reservasss', label: 'Reservations' },
            { id: '#nwp-centro-convenciones-aditional-services', label: 'Additional services' }, // Añadido 'Additional services' en inglés
            { id: '#nwp-centro-convenciones-visit-us', label: 'Visit us' },
          ],
        }}
      />
    </div>
...
const container = document.getElementById('nwp-centro-convenciones-hero');
if (container) {
