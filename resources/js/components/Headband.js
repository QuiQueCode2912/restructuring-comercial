...
export default function Headband({ imageSrc, mainTitle, subtitle, instagramLink, instagramHandle, backgroundColorClass = 'bg-verde-habitat-accesible' }) {
  return (
    <>
      ...
      {/* Aplicamos la clase pasada por props o la clase predeterminada */}
      <div className={`nwp-padding-x-container ${backgroundColorClass}`}>
