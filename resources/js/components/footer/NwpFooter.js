...
export default function NwpFooter() {
  ...
  return (
    <div className='w-full bg-black'>
      ...
      <div className='md:pt-14 pt-6 pb-8 grid grid-flow-row md:grid-flow-col md:grid-cols-11 gap-y-6 md:gap-y-0 md:gap-x-4 nwpcontainer mx-auto'>
      ...
      <div className='hidden md:grid grid-cols-5 gap-x-4 nwpcontainer mx-auto py-8 border-t border-zinc-800'>
      ...
      <ul className='flex flex-col gap-y-4 font-semibold py-4 md:hidden border-y border-zinc-800'>
        {menuOptions.map((option, index) => (
          <li key={index}>
            <button
      ...
      <div className='flex flex-col gap-y-2 md:gap-y-0 md:flex-row md:divide-x md:px-0 px-4 divide-white py-4 md:border-t border-zinc-800 nwpcontainer mx-auto'>
        <a className='underline text-white hover:text-white' href="#">Mapa de sitio</a>
        <a className='underline text-white hover:text-white' href="#">Términos y condiciones</a>
        <a className='underline text-white hover:text-white' href="#">Política de cookies</a>
