...
<div class="container" style="margin:0 auto; padding:0; position:relative">
  <a href="/assets/images/complejo-hospedaje.png" data-lightbox="venue" title="<h1>Complejo de hospedaje</h1>Los salones tienen capacidad para hasta 24 personas, en formato aula de clases; ideales para reuniones corporativas o académicas.<br><br><a href='#'>Revisa la política COVID para este venue</a>" class="gallery">FOTOGALERÍA <span>+</span></a>
...
<div id="home-carousel" class="carousel slide venue-main-image" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/assets/images/complejo-hospedaje.png" class="d-block" alt="...">
    </div>
  </div>
</div>
...
<div class="container venue-detail">
  <div class="row">
    <div class="col-12">
      <h6>Complejo de hospedaje</h6>
      <h1>Descansa, sueña y crea</h1>
      <p class="description">
      El Complejo de Hospedaje ofrece estratégicamente 96 habitaciones con alojamiento para 190 personas. Si eres estudiante, profesor o un profesional que participa de nuestro amplio programa de seminarios de capacitación o consultoría, o simplemente organizas o asistes a un congreso de <strong>Ciudad del Saber</strong>, este hospedaje a corto plazo será perfecto para tí. 
      </p>
      <p><span style="color:#0088ff">/ La Plaza /</span> 
      Principal punto de encuentro para nuestra comunidad, se encuentra a menos 
de cinco minutos caminando. La arquitectura abierta al entorno combina perfectamente con 
su variada oferta de servicios gastronómicos, librerías, alquiler de bicicletas y galerías de arte, además de actividades culturales y recreativas.
      </p>
    </div>
  </div>
