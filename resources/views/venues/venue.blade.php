...
@if(request()->is('centro-convenciones'))
    <div id="nwp-centro-convenciones-hero"></div>
    <div id="nwp-centro-convenciones-content-section-whith-an-image"></div>
    <div id="nwp-centro-convenciones-gallery-section"></div>
    <div id="nwp-centro-convenciones-campus-facilities"></div>
@endif
@if(request()->is('e-109'))
    <div id="nwp-e-109-hero"></div>
    <div id="nwp-e-109-content-section-whith-an-image"></div>
        ...
        <div class="">
          <div class="row">
            <div class="col-12 col-md-12">
              ...
              @endif
              @if(request()->is('e-109'))
                  <p class="font-bold text-3xl md:text-5xl text-black md:w-3/5">El escenario ideal para tus encuentros académicos y empresariales e-109</p>
                  <p class="text-lg  md:w-3/5 py-3">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Elementum sagittis vitae et leo duis ut. Ut tortor pretium viverra suspendisse potenti.
                  </p>
              @endif
              ...
              @endif
              @if(request()->is('e-104'))
                  <p class="font-bold text-3xl md:text-5xl text-black md:w-3/5">El escenario ideal para tus encuentros académicos y empresariales e-104</p>
                  <p class="text-lg  md:w-3/5 py-3">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Elementum sagittis vitae et leo duis ut. Ut tortor pretium viverra suspendisse potenti.
                  </p>
              @endif
              ...
              @endif
              @if(request()->is('e-300'))
                  <p class="font-bold text-3xl md:text-5xl text-black md:w-3/5">El escenario ideal para tus encuentros académicos y empresariales e-300</p>
                  <p class="text-lg  md:w-3/5 py-3">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Elementum sagittis vitae et leo duis ut. Ut tortor pretium viverra suspendisse potenti.
                  </p>
              @endif
...
@endif
@if(request()->is('centro-convenciones'))
    <div id="nwp-centro-convenciones-aditional-services"></div>
    <div id="nwp-centro-convenciones-visit-us"></div>
@endif
@if(request()->is('e-109'))
