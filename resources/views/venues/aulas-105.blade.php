...
<div class="container" style="margin:0 auto; padding:0; position:relative">
  <a href="/assets/images/aulas-105.png" data-lightbox="venue" title="<h1>Aulas 105</h1>Los salones tienen capacidad para hasta 24 personas, en formato aula de clases; ideales para reuniones corporativas o académicas.<br><br><a href='#'>Revisa la política COVID para este venue</a>" class="gallery">FOTOGALERÍA <span>+</span></a>
...
<div id="home-carousel" class="carousel slide venue-main-image" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/assets/images/aulas-105.png" class="d-block" alt="...">
    </div>
  </div>
</div>
...
<div class="container venue-detail">
  <div class="row">
    <div class="col-12">
      <h6>Aulas 105</h6>
      <h1>Estudia y mejora el futuro</h1>
      <p class="description">
      Las Aulas 105 están estratégicamente pensadas para realizar actividades de negocios y formación académica, además de ofrecer capacitaciones originadas por institutos de Educación Superior, Entidades Gubernamentales, Organismos Internacionales y Empresas. Con sus amplias instalaciones, que incluyen aulas de clases, internet inalámbrico, comedor (catering disponible) y mobiliario, se pueden desarrollar todo tipo de eventos.
      </p>
      <p><span style="color:#0088ff">/ Fácil y rápido acceso /</span> 
      Todos los salones del Centro tienen servicio de Internet inalámbrico, además de proyector, pantalla y mobiliario. Cuentan con capacidad mínima de 15 personas y máxima de 80 en montaje tipo auditorio.
      </p>
    </div>
  </div>
