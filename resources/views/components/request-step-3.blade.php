...
<div class="request-step" style="margin-top:0px;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group-preview">
                    DV: <?php echo session()->get('00NRb000000Ex1p'); ?>
                    <a href="/cotizacion/datos-contacto#00NRb000000Ex1p">Editar</a>
                </div>
            </div>
            <!-- <div class="col-12 col-md-6">
        <div class="form-group-preview">
          ...
          switch (session()->get('country_code')) {
              ...
              case 'BT':
                  ...
                  break;
              case 'BO':
                  echo 'Bolivia, Plurinational State of';
                  break;
              case 'BQ':
                  echo 'Bonaire, Sint Eustatius and Saba';
                  break;
              case 'BA':
              ...
              case 'KI':
                  ...
                  break;
              case 'KP':
                  echo 'Korea, Democratic People&#39;s Republic of';
                  break;
              case 'KR':
                  echo 'Korea, Republic of';
                  break;
              case 'KW':
                  echo 'Kuwait';
                  break;
              ...
              case 'MO':
                  ...
                  break;
              case 'MK':
                  echo 'Macedonia, the former Yugoslav Republic of';
                  break;
              case 'MG':
                  echo 'Madagascar';
                  break;
              ...
              case 'BL':
                  ...
                  break;
              case 'SH':
                  echo 'Saint Helena, Ascension and Tristan da Cunha';
                  break;
              case 'KN':
              ...
              case 'TJ':
                  ...
                  break;
              case 'TZ':
                  echo 'Tanzania, United Republic of';
                  break;
              case 'TH':
                  echo 'Thailand';
                  break;
              ...
              case 'VU':
                  ...
                  break;
              case 'VE':
                  echo 'Venezuela, Bolivarian Republic of';
                  break;
              case 'VN':
                  echo 'Vietnam';
                  break;
                            ...
                            <script>
                                ...
                                var formatReservas = function(reservas) {
                                    ...
                                    reservas.forEach(function(reserva, index) {
                                        var horaInicio = reserva.venue != 'PISCINA' ? reserva.id.substring(7, 9) : reserva.id.substring(
                                            7, 12).replace('-', ':');
                                        var horaInicioFormateada = reserva.venue != 'PISCINA' ? formatHora(horaInicio) :
                                            formatPiscinaHora(horaInicio);
    ...
    ?>
            <div class="col-12 col-md-6">
                ...
                <div class="form-group-preview" style="background:transparent"><a href="/cotizacion/datos-evento#file"
                        style="left:0">Editar</a></div>
                <?php endif ?>
            </div>
        ...
        <div class="row  mt-4">
            <div class="col-8 col-md-8">
                <div class="form-group">
                    <input type="email" class="form-control" name="cupon" id="cupon"
                        placeholder="Tienes un cupón?" style="height: 39px" value="<?php echo session()->get('cupon'); ?>">
                </div>
            </div>
    ...
    ?>
                ...
                <div class="col-12">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="accept-policy"
                            ...
                            Al marcar esta casilla se asume que he leído, entendido y acepto las <a href=""
                                data-toggle="modal" data-target="#myModal" style="cursor: pointer;"><b>políticas de
                                    reserva y cancelación de espacios de CDS</b></a>. De acuerdo a lo establecido en la
                            política, confirmo que también entiendo las condiciones de reembolso y los procedimientos
            ...
            <div class="modal-dialog  modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Políticas de reserva y cancelación de espacios
                            de CDS</h5>
                    ...
                    <div class="modal-body">
                        <p><strong>Por favor, tenga en cuenta las siguientes normas y políticas durante su visita al
                                Parque Ciudad del Saber:</strong></p>
                        <ul>
                            <li>No se permite el consumo y venta de bebidas alcohólicas.</li>
                            <li>No se permite la venta de comida y bebidas (sodas, aguas, bebidas energizantes, etc.).
                            </li>
                            <li>No se permite fumar.</li>
                            <li>Cumplir con el uso apropiado de los estacionamientos. No se pueden estacionar en los
                                laterales de la vía principal del Parque.</li>
                            <li>No se permite el uso de murgas, troneras, parlantes, bocinas, micrófonos y otros
                                instrumentos de ruido excesivo.</li>
                            <li>Se le solicita depositar los desechos de basura que se produzcan durante el uso de la
                                instalación en los cestos de basura. Se le hará un cargo de B/. 100.00 en caso de
                                encontrar algún tipo de desecho en el área asignada.</li>
                            <li>LA FUNDACIÓN por condiciones climatológicas se reserva el derecho de uso de las
                                instalaciones para preservar el buen estado de estas.</li>
                            <li>LA FUNDACIÓN no se hará responsable por la pérdida de objetos de valor (prendas,
                                celulares, equipos deportivos, etc.) durante el desarrollo de las actividades.</li>
                            <li>El Cliente exonera a LA FUNDACIÓN de cualquier imprevisto, lesión o accidente que ocurra
                                con algún participante durante las actividades del evento.</li>
                            <li>Respetar y obedecer las instrucciones del personal del Parque Ciudad del Saber y agentes
                                de Seguridad de CdS.</li>
                            <li>Se prohibe los actos de violencia, riña y palabras ofensivas durante las actividades. De
                                ocurrir algunos de estos hechos, El Cliente deberá expulsar al equipo o persona que
                                incurrió en la falta y, de tratarse de la barra, está deberá abandonar las
                                instalaciones.</li>
                            <li>El marcado del cuadro o la cancha será por cuenta de El Cliente.</li>
                            <li>Las cancelaciones realizadas <strong>12 horas antes</strong> de la fecha reservada
                                recibirán un reembolso del <strong>100%</strong>.</li>
                            <li>Las cancelaciones realizadas <strong>dentro de las 12 horas</strong> antes de la fecha
                                reservada recibirán un reembolso del <strong>50%</strong>.</li>
                            <li><strong>Por favor, tenga en cuenta que los reembolsos sólo se tramitarán por
                                    ACH</strong>.</li>
                        </ul>
        ...
        <div class="row buttons">
            <div class="col-12 text-center">
                ...
                ?>
                <input type=hidden name="oid" value="00DO90000018vOj">
