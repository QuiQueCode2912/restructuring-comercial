        ...
        <form action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
          ...
          <div class="col-12 col-md-6">
              <div class="form-group required">
                <input type="text" class="form-control" name="first_name" maxlength="40" id="first_name" required placeholder="Nombres">
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-group required">
                <input type="text" class="form-control" name="last_name" maxlength="80" id="last_name" required placeholder="Apellidos">
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-group required">
            ...
            <div class="col-12 col-md-6">
              <div class="form-group required">
                <input type="text" class="form-control" id="phone" name="phone" maxlength="20" required placeholder="Número telefónico">
              </div>
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">
                <select id="00N3m00000QMsC5" name="00N3m00000QMsC5">
                  ...
                  <option value="Semi-presencial">Evento semi-presencial</option>
                  <option value="Hospedaje">Hospedaje</option>
                  <option value="Vivienda">Vivienda</option>
                  <option value="No estoy seguro, necesito asesoramiento">No estoy seguro, necesito asesoramiento</option>
                </select>
              </div>
            </div>
            <div class="col-12 col-md-6">
