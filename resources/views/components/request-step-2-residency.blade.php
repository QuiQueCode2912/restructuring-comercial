<div class="request-step">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6">
        <div class="form-group required">
          <input type="text" class="form-control" id="size" placeholder="Metros cuadrados">
        </div>
      </div>
      <div class="col-12 col-md-6">
        <div class="form-group required">
          <input type="text" class="form-control datepicker" id="start-date" placeholder="Fecha de inicio de la renta">
        </div>
      </div>
      <div class="col-12 col-md-6">
        <div class="form-group required">
          <input type="text" class="form-control datepicker" id="end-date" placeholder="Fecha de finalización de la renta">
        </div>
      </div>
      <div class="col-12 col-md-6">
