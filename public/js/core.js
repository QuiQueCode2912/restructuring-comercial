  ...
  \******************************/
            ...
            /***/ function (module, exports) {
                ...
                function validateSelDate(venueId, selDate, todayDate) {
                    ...
                    const customEve = new CustomEvent("dateSelected", {
                        detail: {
                          currentDate: selDate,
                        },
                      });
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            const customEve = new CustomEvent("slotsSelected", {
                                detail: {
                                  slotsSelected: response,
                                },
                              });
                            window.dispatchEvent(customEve);
                            ...
                            for (var i = 7; i <= 20; i++) {
                                var controlIdx = "" + i;
                                if (i < 10) controlIdx = "0" + i;
                                //        console.log('Limpiando: ' + controlIdx);
                                $(
                                    "[id^='chkhora" + controlIdx + "']"
                                ...
                                if (
                                    (selDate == todayDate && i <= hour) ||
                                    ((dayOfWeek === 0 || dayOfWeek === 6) &&
                                        i > 17)
                                ) {
                                    $("#trHora" + controlIdx).css(
                                        "display",
                                        "none"
                                    );
                                } else {
                            ...
                            if (response.length > 0) {
                                ...
                                for (var i = 7; i <= 20; i++) {
                                    for (var j = 0; j < eventos.length; j++) {
                                        var dateI = new Date(
                                            eventos[j].StartDateTime
                                        );
                                        var dateF = new Date(
                                            eventos[j].EndDateTime
                                        );
                                ...
                                console.log(
                                    "** No response:  no se detectaron reservas **"
                                );
                            }
                            ...
                            for (var i = 0; i < selVenues.length; i++) {
                                if (selVenues[i].fecha == fecha) {
                                    if (
                                        ...
                                        var selVenues = $(
                                            ...
                                            : JSON.parse("[]");
                                        selVenues = selVenues.filter(function (
                                            venue
                                        ) {
                                            return (
                                                venue.id !== selVenues[i].id ||
                                                venue.fecha !== fecha
                                            );
                                        });
                                        //TODO: CAMBIAR LO DE ARRIBA POR ELIMINARVENUE
                                        $("#ReservasSeleccionadas").val(
                                            JSON.stringify(selVenues)
                                        );
                                        ...
                                        var clave = selVenues[i].id.substr(
                                            selVenues[i].id.length - 18
                                        );
                                  

                                        // Remove "chkhora" from the string
                                        var resultString = selVenues[i].id.replace('chkhora', '');
                                        var timeSelected = resultString.substring(0, 2);

                                        validateBasketCourt(clave,timeSelected,false);
                                        var franja =
                                            $("#franja-seleccion").val();
                                ...
                                // agregar los botones
                                var cantidadSeleccionada = selVenues.filter(
                                    (x) => x.fecha === selVenues[i].fecha
                                ).length;
                                $("#esPlaceholder").hide();
                                ...
                                if (botonesExistes.length > 0) {
                                    ...
                                    espaciosSeleccionados.appendChild(
                                        nuevoBoton
                                    );
                                }
                                // hasta aqui
                        ...
                        error: function (x, xs, xt) {
                            ...
                            setTimeout(function () {
                                validateSelDate(venueId, selDate, todayDate);
                            }, 2000);
                        },
                    });
                }
                ...
                $("#start-date").load("ajax/ignorar.html", function () {
                    if (
                        $("input.datepicker#start-date").data(
                            "setavailablehours"
                        ) == true &&
                        firstTime == true
                    ) {
                ...
                $(document).ready(function () {
                    ...
                    if (
                        ...
                        maxLimitDate =
                            today.getFullYear() + "-" + mesS + "-" + diaS;
                        checkPiscinaHours(today.getDay());
                    ...
                    $("input.datepicker#start-date").on(
                        ...
                        function (ev, picker) {
                            if (
                                ...
                                venueId = $("#venueId").val();
                                selDate = $(
                                    "input.datepicker#start-date"
                                ).val();
                                var inputDate = new Date(selDate);
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        //location.reload();
                                        //$("#elemento").load(location.href + " #elemento");
                                        let res = JSON.parse(data);
                                        checkPiscinaHours(res.message);
                                    },
                    ...
                    if (
                        $("input.datepicker#start-date").length > 0 &&
                        $("input.datepicker#end-date").length > 0
                    ) {
                        $("input.datepicker#start-date").on(
                            "apply.daterangepicker",
                            function (ev, picker) {
                                var date = new Date(
                                    $("input.datepicker#start-date").val()
                                );
                    ...
                    if ($("#home-carousel").length > 0) {
                        ...
                        if (
                            height <=
                            ($("#home-carousel").hasClass("venue-main-image")
                                ? 480
                                : 630)
                        ) {
                            $("#home-carousel").height(height + "px");
                            $("#home-carousel .carousel-inner").height(
                                height + "px"
                            );
                        }
                    }
                    ...
                    if ($(".searcher.aside").length > 0) {
                        $(".searcher.aside").css({
                            left:
                                "calc(50% + " +
                                parseInt($(".header .container").width()) *
                                    0.25 +
                                "px)",
                        });
                    ...
                    //Para chequear si es cancha completa y mitad
                    window.validateBasketCourt = function (venueId,time,isSelected){
                
                        //Casos para reserva desde cancha completa
                        if(venueId == '02i3m00000D9GuDAAV' && !isSelected){
                            $(`#chkhora${time}02i3m00000D9Gu8AAF`).addClass('unclickable')
                            $(`#chkhora${time}02i3m00000Fc266AAB`).addClass('unclickable')            
                        }
                
                        if(venueId == '02i3m00000D9GuDAAV' && isSelected){
                            $(`#chkhora${time}02i3m00000D9Gu8AAF`).removeClass('unclickable')
                            $(`#chkhora${time}02i3m00000Fc266AAB`).removeClass('unclickable')            
                        }
                
                        if( (venueId == '02i3m00000D9Gu8AAF' || venueId == '02i3m00000Fc266AAB' )  && !isSelected){
                            $(`#chkhora${time}02i3m00000D9GuDAAV`).addClass('unclickable');
                            
                        }
                
                        if( (venueId == '02i3m00000D9Gu8AAF' || venueId == '02i3m00000Fc266AAB' )  && isSelected){
                            if(venueId == '02i3m00000D9Gu8AAF' && $(`#chkhora${time}02i3m00000Fc266AAB`).hasClass('selected')){
                                return;
                            }
                            if(venueId == '02i3m00000Fc266AAB' && $(`#chkhora${time}02i3m00000D9Gu8AAF`).hasClass('selected')){
                                return;
                            }
                            $(`#chkhora${time}02i3m00000D9GuDAAV`).removeClass('unclickable');
                    ...
                    window.almacenarVenue = function (
                        ...
                        if (reemplazar) {
                            ...
                            selVenues = selVenues.filter(
                                (x) =>
                                    !(
                                        x.fecha === fechaActual &&
                                        x.id.endsWith(assetId)
                                    )
                            );
                        }
                        var objeto = {
                        ...
                        if (elementosPorRango >= 2) {
                            console.log(
                                "Se ha alcanzado el límite de 2 elementos para el rango"
                            );
                            return false;
                        }
                        ...
                        if (
                            !selVenues.find(
                                (x) => x.id === id && x.fecha === fechaActual
                            )
                        ) {
                            selVenues.push(objeto);
                            var count = selVenues.filter(
                                (x) => x.fecha === fechaActual
                            ).length;
                    ...
                    window.almacenarVenueMensual = function (
                        venueId,
                        fechaActual,
                        nombreVenue
                    ) {
                        ...
                        var fechas = selVenues.map(function (a) {
                            return new Date(a.fecha);
                        });
                        var fechaInicial =
                            fechas.length > 0
                                ? Math.min.apply(null, fechas)
                        ...
                        var fecha5 = new Date(fechaInicial);
                        fecha5.setDate(fecha5.getDate() + 28);
                        ...
                        if (
                            fechaActualDate >= fecha1 &&
                            fechaActualDate < fecha2
                        )
                            fechaEnRango = fecha1;
                        if (
                            fechaActualDate >= fecha2 &&
                            fechaActualDate < fecha3
                        )
                            fechaEnRango = fecha2;
                        if (
                            fechaActualDate >= fecha3 &&
                            fechaActualDate < fecha4
                        )
                            fechaEnRango = fecha3;
                        if (
                            fechaActualDate >= fecha4 &&
                            fechaActualDate < fecha5
                        )
                            fechaEnRango = fecha4;
                        console.log(
                            "La fecha está en el rango: " + fechaEnRango
                        );
                        if (!fechaEnRango) {
                            console.log(
                        ...
                        var elementosPorRango = selVenues.filter(
                            (x) =>
                                new Date(x.fecha) >= fechaEnRango &&
                                new Date(x.fecha) < new Date(fecha5)
                        ).length;
                        console.log(
                            "elementosPorRango: " + (elementosPorRango + 1)
                        );
                        if (elementosPorRango >= 4) {
                            console.log(
                                "Se ha alcanzado el límite de 4 elementos para el rango"
                            );
                            return false;
                        }
                    ...
                    window.agregarBoton = function (
                        variableFecha,
                        cantidadSeleccionada
                    ) {
                        $("#esPlaceholder").hide();
                        var botonNombre = "show" + variableFecha;
                        var botonesExistes = $("#espaciosSeleccionados").find(
                            "#" + botonNombre
                        );
                        ...
                        if (botonesExistes.length > 0) {
                            ...
                            var espaciosSeleccionados = document.getElementById(
                                "espaciosSeleccionados"
                            );
                    ...
                    window.eliminarBoton = function (fecha) {
                        ...
                        var botonEliminar = $("#espaciosSeleccionados").find(
                            "#" + botonNombre
                        );
                        botonEliminar.remove();
                        if (
                            $("#espaciosSeleccionados").children().length <= 1
                        ) {
                            $("#esPlaceholder").show();
                        }
                    };
                    window.addEventListener("scroll", function (e) {
                        ...
                        if ($(".searcher.aside").length > 0) {
                            var scrollTo =
                                parseInt($(".venues-list").height()) +
                                260 -
                                (parseInt($(".searcher.aside").height()) + 80);
                        ...
                        if ($(".venue-characteristics").length > 0) {
                            var scrollTo =
                                parseInt($(".venue-detail").height()) +
                                260 -
                                parseInt($(".venue-characteristics").height());

                            if (
                                scrollY >
                                    parseInt(
                                        $(".venue-detail .shortcuts").offset()
                                            .top
                                    ) -
                                        20 &&
                                scrollY < scrollTo
                    ...
                    $(document).on(
                        {
                            click: function click(e) {
                                e.preventDefault();
                                var security_policies_modal =
                                    new bootstrap.Modal(
                                        document.querySelector(
                                            ".modal#security-policies"
                                        ),
                                        {
                                            keyboard: false,
                                        }
                    ...
                    $(document).on(
                        {
                            click: function click(e) {
                                e.preventDefault();
                                $(".modal#security-policies").removeClass(
                                    "show"
                                );
                    ...
                    if ($(".other-methods #total").length > 0) {
                        $(".other-methods #total").val(
                            $(".form-check .form-check-input:checked").attr(
                                "value"
                            )
                        );
                        $(".yappyForm #total").val(
                ...
                var checkPiscinaHours = function checkPiscinaHours(message) {
                    //Para el dia Lunes
                    if (message == 0) {
                        $(".horarios-piscina-martes").hide();
                        $(".horarios-piscina-miercoles").hide();
                        $(".horarios-piscina-jueves").hide();
                        $(".horarios-piscina-viernes").hide();
                        $(".horarios-piscina-sabados").hide();
                        $(".horarios-piscina-domingos").hide();
                    }

                    //Para el dia de  martes
                    if (message == 1) {
                        $(".horarios-piscina-martes").show();
                    ...
                    //Para el dia de  Miercoles
                    if (message == 2) {
                        $(".horarios-piscina-miercoles").show();
                      ...
                      if (message == 3) {
                        $(".horarios-piscina-jueves").show();
                         ...
                         //Para el dia de  Viernes
                      if (message == 4) {
                        $(".horarios-piscina-viernes").show();
                    ...
                    //Para el dia domingo
                    if (message == 6) {
                        $(".horarios-piscina-domingos").show();
                ...
                setTimeout(function () {
                    if (document.getElementById("twitter-timeline") > 0) {
                        ...
                        twttr.events.bind("rendered", function (event) {
                            ...
                            $.each(
                                $(
                                    "footer #twitter-timeline .timeline-Widget .timeline-Body .timeline-Viewport .timeline-TweetList .timeline-TweetList-tweet"
                                ),
                                function (index, element) {
                                    if (index > 2) {
                                        $(element).addClass(
                                            "twitter-remove-element"
                                        );
                                    }
                                }
                            );
                            $(
                                "footer #twitter-timeline .twitter-remove-element"
                            ).remove();
  ...
  \************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! /Users/navi/Work/Sites/ciudaddelsaber.org/eventos/comercial/resources/js/core.js */ "./resources/js/core.js"
                );
